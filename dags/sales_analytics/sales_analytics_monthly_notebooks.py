...
MONTHLY_NOTEBOOKS_PATH = "analytics/sales_analytics_notebooks/monthly/"
...
def get_monthly_notebooks(path):
    notebooks = []
    fileNames = []
...
notebooks = get_monthly_notebooks(MONTHLY_NOTEBOOKS_PATH)
