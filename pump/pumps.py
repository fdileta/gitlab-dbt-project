...
def get_copy_command(model, sensitive, stage, timestamp, inc_start, inc_end):
    """
...
def copy_data(model, sensitive, stage, timestamp, inc_start, inc_end):
    """
    ...
    try:
        ...
        copy_command = get_copy_command(model, sensitive, stage, timestamp, inc_start, inc_end)
