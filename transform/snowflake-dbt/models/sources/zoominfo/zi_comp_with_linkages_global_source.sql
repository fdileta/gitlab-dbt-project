...
renamed AS (
  ...
  SELECT
    ...
    zi_c_is_ultimate_parent::BOOLEAN                                                 AS is_global_parent,
    ...
    zi_c_ultimate_parent_company_id::NUMBER                                          AS global_parent_company_id,
    zi_es_ultimate_parent_ecid::NUMBER                                               AS everstring_global_parent_id,
    ...
    NULLIF(zi_c_ultimate_parent_street::VARCHAR, '')                                 AS global_parent_street,
    NULLIF(zi_c_ultimate_parent_street_2::VARCHAR, '')                               AS global_parent_street_2,
    NULLIF(zi_c_ultimate_parent_city::VARCHAR, '')                                   AS global_parent_city,
    NULLIF(zi_c_ultimate_parent_zip::VARCHAR, '')                                    AS global_parent_zip,
    NULLIF(zi_c_ultimate_parent_state::VARCHAR, '')                                  AS global_parent_state,
    NULLIF(zi_c_ultimate_parent_country::VARCHAR, '')                                AS global_parent_country,
