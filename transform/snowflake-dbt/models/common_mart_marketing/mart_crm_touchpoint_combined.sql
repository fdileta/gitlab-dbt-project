...
, unioned AS (
 SELECT 
      ...
      mart_crm_touchpoint.dim_crm_account_id, --20
    ...
    END AS region_normalized, --5
      ...
      mart_crm_attribution_touchpoint.dim_crm_account_id, --20
      ...
      SUM(mart_crm_attribution_touchpoint.first_weight) AS first_opp_created,
      SUM(mart_crm_attribution_touchpoint.u_weight) AS u_shaped_opp_created,
      SUM(mart_crm_attribution_touchpoint.w_weight) AS w_shaped_opp_created,
      SUM(mart_crm_attribution_touchpoint.full_weight) AS full_shaped_opp_created,
      SUM(mart_crm_attribution_touchpoint.custom_weight) AS custom_opp_created,
      ...
      CASE
        WHEN mart_crm_attribution_touchpoint.is_sao = TRUE
          THEN SUM(mart_crm_attribution_touchpoint.first_weight) 
        ELSE 0 
      END AS first_sao,
      CASE 
        WHEN mart_crm_attribution_touchpoint.is_sao = TRUE
          THEN SUM(mart_crm_attribution_touchpoint.u_weight) 
        ELSE 0 
      END AS u_shaped_sao,
      CASE 
        WHEN mart_crm_attribution_touchpoint.is_sao = TRUE
          THEN SUM(mart_crm_attribution_touchpoint.w_weight) 
        ELSE 0 
      END AS w_shaped_sao,
      CASE 
        WHEN mart_crm_attribution_touchpoint.is_sao = TRUE
          THEN SUM(mart_crm_attribution_touchpoint.full_weight) 
        ELSE 0 
      END AS full_shaped_sao,
      CASE 
        WHEN mart_crm_attribution_touchpoint.is_sao = TRUE
          THEN SUM(mart_crm_attribution_touchpoint.custom_weight) 
        ELSE 0 
      END AS custom_sao,
      CASE 
        WHEN mart_crm_attribution_touchpoint.is_sao = TRUE
