...
, unioned AS (
    SELECT
      ...
      is_mql,
      is_fmm_influenced,
      rpt_sfdc_bizible_tp_person_lifecycle.bizible_touchpoint_source,
      rpt_sfdc_bizible_tp_person_lifecycle.bizible_ad_content,
      rpt_sfdc_bizible_tp_person_lifecycle.bizible_ad_group_name,
      rpt_sfdc_bizible_tp_person_lifecycle.bizible_form_url_raw,
