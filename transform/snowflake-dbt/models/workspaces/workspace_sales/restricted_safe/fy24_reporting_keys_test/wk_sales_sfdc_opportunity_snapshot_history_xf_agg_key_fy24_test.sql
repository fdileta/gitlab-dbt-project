{{ config(alias='sfdc_opportunity_snapshot_history_xf_agg_key_fy24_test') }}
-- TODO
...
WITH date_details AS (
    ...
    SELECT 
      ...
      bu_geo_region_area_segment_rt,
      bu_geo_region_area_segment_rt_pc_ap,
      ...
      key_pc_bu_geo,
      key_ap_bu_geo,
      key_bu_geo_region_area,
      key_bu_geo_region_rt,
      key_bu_geo_segment_region,
      key_bu_geo_segment_rt,
      key_bu_geo_region_area_segment,
      key_bu_geo_region_area_rt,
      key_bu_geo_segment_region_area,
      key_bu_geo_segment_region_rt,
    ...
    FROM {{ref('wk_sales_sfdc_opportunity_xf_agg_key_fy24_test')}}
    ...
    SELECT DISTINCT
      ...
      sfdc_opportunity_xf.key_rt,
      sfdc_opportunity_xf.key_pc,
      sfdc_opportunity_xf.key_ap,

      sfdc_opportunity_xf.key_bu_geo,
      sfdc_opportunity_xf.key_pc_bu,
      sfdc_opportunity_xf.key_ap_bu,
      sfdc_opportunity_xf.key_bu_geo_region,
      sfdc_opportunity_xf.key_bu_geo_segment,
      sfdc_opportunity_xf.key_bu_geo_rt,
      sfdc_opportunity_xf.key_pc_bu_geo,
      sfdc_opportunity_xf.key_ap_bu_geo,
      sfdc_opportunity_xf.key_bu_geo_region_area,
      sfdc_opportunity_xf.key_bu_geo_region_rt,
      sfdc_opportunity_xf.key_bu_geo_segment_region,
      sfdc_opportunity_xf.key_bu_geo_segment_rt,
      sfdc_opportunity_xf.key_bu_geo_region_area_segment,
      sfdc_opportunity_xf.key_bu_geo_region_area_rt,
      sfdc_opportunity_xf.key_bu_geo_segment_region_area,
      sfdc_opportunity_xf.key_bu_geo_segment_region_rt,
      sfdc_opportunity_xf.key_bu_geo_region_area_segment_rt,
      sfdc_opportunity_xf.key_bu_geo_segment_region_area_rt,
      sfdc_opportunity_xf.bu_geo_region_area_segment_rt_pc_ap,
