{{ config(alias='report_opportunity_metrics_qtd_test_new_key') }}
...
WITH sfdc_opportunity_xf AS (
    ...
    SELECT
      ...
      oppty.report_user_segment_geo_region_area_sqs_ot_rt,
    ...
    SELECT 
      opp_snapshot.report_user_segment_geo_region_area_sqs_ot_rt,
    ...
    LEFT JOIN pipe_gen_yoy
        ON agg.report_user_segment_geo_region_area_sqs_ot_rt = pipe_gen_yoy.report_user_segment_geo_region_area_sqs_ot_rt
    LEFT JOIN agg_demo_keys
        ON agg.report_user_segment_geo_region_area_sqs_ot_rt = agg_demo_keys.report_user_segment_geo_region_area_sqs_ot_rt
  )
