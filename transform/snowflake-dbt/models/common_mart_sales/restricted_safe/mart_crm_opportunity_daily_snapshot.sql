...
final AS (
  ...
  SELECT
    ...
    dim_crm_account.parent_crm_account_sales_segment AS account_demographics_segment,
    dim_crm_account.parent_crm_account_sales_territory AS account_demographics_territory,
    dim_crm_account.parent_crm_account_tsp_region AS account_demographics_region,
    dim_crm_account.parent_crm_account_tsp_area AS account_demographics_area,
